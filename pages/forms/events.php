        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Events Form</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <select id="sel" name="sel"  class="form-control select2" style="width: 100%;">
                    <option selected="selected">Select Filing category</option>
                    <option value="">Litigation</option>
                    <option value="">Conveyancing</option>
                    <option value="">Criminal Law</option>
                    <option value="">Foreign Law</option>
              ...
              <div class="col-md-6">
                ...
                <div class="form-group">
                 ...
                 <input type="Number" class="form-control" id="case" name="case" placeholder="Please Enter case Number">
              ...
              <div class="col-12 col-sm-6">
                <div class="form-group">
                  <label for="client">Client</label>
                   <input type="Text" class="form-control" id="client" name="client" placeholder="Please Enter client Name">
